...
export default function GuestCheckoutRoute() {
  ...
  async function handleCreateOrder() {
    ...
    try {
      ...
      router.replace({ pathname: '/payments/[intentId]', params: { intentId: intent.intentId } });
    } catch (err) {
      setError(getAuthErrorMessage(err));
    } finally {
      setSubmitting(false);
      ...
      <IosScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.helperRow}>
            <AppIcon name="MapPin" size={15} color="#FFFFFF" />
        ...
        <View style={styles.section}>
          ...
          <View style={styles.helperRow}>
            <AppIcon name="ShieldCheck" size={15} color="#FFFFFF" />
            <AppText style={styles.helperText}>
          ...
          {paymentMethod ? (
            <View style={styles.summaryRow}>
              {getPaymentMethodImage(paymentMethod) ? (
                <Image
                  source={getPaymentMethodImage(paymentMethod)!}
...
const styles = StyleSheet.create({
  ...
  materialText: { fontSize: 12, fontWeight: '700', color: 'rgba(255, 255, 255, 0.5)', fontFamily: 'SF-Pro-Display-Regular' },
