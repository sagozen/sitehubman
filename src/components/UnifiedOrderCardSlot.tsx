...
export function UnifiedOrderCardSlot({
  ...
  function renderSkeletonCard(variant: 'primary' | 'secondary') {
    return (
      ...
      >
        <View style={[styles.skeleton, isDark && styles.skeletonDark, { width: cardWidth, height: cardHeight }]}>
          <View style={styles.skeletonGhost} pointerEvents="none">
            <View style={[styles.skeletonChip, isDark && styles.skeletonChipDark]} />
            <View style={[styles.skeletonLineWide, isDark && styles.skeletonLineWideDark]} />
            <View style={[styles.skeletonLine, isDark && styles.skeletonLineDark]} />
          </View>
          <View style={styles.plusCenter}>
            <View style={[styles.plusFab, isDark && styles.plusFabDark]}>
              <AppIcon name="Plus" size={30} color={isDark ? '#FFFFFF' : '#2596BE'} />
            </View>
            <AppText style={[styles.plusLabel, isDark && styles.plusLabelDark]}>
