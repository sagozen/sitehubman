...
const icons = {
  ...
  CheckCircle,
  ChevronDown: AltArrowRight, // rotated 90deg at use site if needed
  ChevronLeft: AltArrowLeft,
  ChevronRight: AltArrowRight,
  ChevronUp: AltArrowRight,
  ClipboardList,
  Clock: ClockCircle,
  CreditCard: Card,
  Circle: RecordCircle,
  ...
  CloudUpload: Upload,
  TrendingUp: GraphUp,
  TrendingDown: GraphUp,
  Minus: MenuDots,
  DollarSign: Dollar,
  Banknote: DollarMinimalistic,
  QrCode,
  ...
  Zap: Bolt,
  ZapOff: BoltCircle,
  Pause: AltArrowRight, // will be re-mapped in the OrderActionBar
  Play: AltArrowRight,
