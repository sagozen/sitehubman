...
// Helper to resolve marketing images using lazy loaders
...
export const MARKETING_IMAGES = {
  get heroHome() {
    return marketingLoaders.heroHome();
  },
  get welcome() {
    return marketingLoaders.welcome();
  },
  get analytics() {
    return marketingLoaders.analytics();
  },
  get designCard() {
    return marketingLoaders.designCard();
  },
  get businessUseCase() {
    return marketingLoaders.businessUseCase();
  },
  get productionTracking() {
    return marketingLoaders.productionTracking();
  },
  get premiumMembership() {
    return marketingLoaders.premiumMembership();
  },
  get shippingSuccess() {
    return marketingLoaders.shippingSuccess();
  },
  get verification() {
    return marketingLoaders.verification();
  },
  ...
  return (
    <View style={[styles.promotionCard, { backgroundColor: colors.surface, borderColor: colors.border }, style]}>
      ...
      <View style={styles.promotionContent}>
        ...
        <AppText variant="body" tone="muted" style={styles.promotionSupport}>
          {supportingText}
        </AppText>
...
const styles = StyleSheet.create({
  ...
  promotionCard: {
    ...
    flexDirection: 'row',
    minHeight: 140,
    ...createShadow({ color: '#000', offset: { width: 0, height: 4 }, opacity: 0.04, radius: 8, elevation: 3 }),
    marginBottom: 20,
  },
