...
const SALES_THEME = pageThemes.sales;

// ─── Tokens ──────────────────────────────────────────────────────────────────

export const salesUi = {
  // Backgrounds
  bg: SALES_THEME.canvas,
  bgGrouped: SALES_THEME.canvas,
  surface: SALES_THEME.surface,
  surfaceRaised: SALES_THEME.surfaceRaised,

  // Borders & separators
  border: SALES_THEME.border,
  separator: SALES_THEME.border,

  // Text
  text: SALES_THEME.text,
  textSecondary: 'rgba(60,60,67,0.6)',
  muted: SALES_THEME.muted,

  // Accents
  accent: SALES_THEME.accent,
  accentSoft: SALES_THEME.accentSoft,
  accentDark: '#E68600',
