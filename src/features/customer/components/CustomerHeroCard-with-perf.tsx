...
export function CustomerHeroCard({ user }: any) {
  ...
  measureRender('CustomerHeroCard');
  ...
  useEffect(() => {
    if (user?.id) {
      // Measure data loading operation
      ...
      <View style={styles.profileHeader}>
        ...
        <View style={styles.headerActions}>
          ...
          <Pressable
            ...
            onPress={() => {
              // Measure interaction
              measure('Sparkles Icon Press', async () => {
                HapticTap.medium();
