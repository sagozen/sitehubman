...
const styles = StyleSheet.create({
  ...
  modalTitle: { flex: 1, textAlign: 'center', color: '#FFFFFF', fontSize: 17 },
  modalHeaderSpacer: { width: 56 },
  modalBody: { padding: 20, gap: 10, paddingBottom: 80, backgroundColor: '#000000' },
  fieldLabel: { fontSize: 13, fontWeight: '600', color: 'rgba(255, 255, 255, 0.55)', marginTop: 10 },
  input: {
  ...
  roleOptionText: { fontSize: 13, fontWeight: '600', color: 'rgba(255, 255, 255, 0.7)' },
  previewCard: {
  ...
  previewRow: { fontSize: 13, color: 'rgba(255, 255, 255, 0.55)' },
  previewVal: { fontWeight: '700', color: '#FFFFFF' },
  previewNote: { fontSize: 12, color: 'rgba(255, 255, 255, 0.4)', marginTop: 6, lineHeight: 17 },
  createBtn: { borderRadius: 14, height: 50, alignItems: 'center', justifyContent: 'center', marginTop: 20, backgroundColor: '#FFFFFF' },
