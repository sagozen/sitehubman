...
export const orderStatusOptions: { label: string; value: OrderStatus; color: string }[] = [
  // ── Simplified 8-step flow labels ──────────────────────────────────────────
  { label: 'Awaiting Approval',  value: 'pending_payment',      color: theme.status.warning  },
  { label: 'Approved',           value: 'production_approved',  color: theme.status.info     },
  { label: 'Printer Queue',      value: 'printer_assigned',     color: theme.roles.printer.primary },
  { label: 'Printing',           value: 'printing',             color: theme.roles.printer.primaryDark },
  { label: 'NFC Write',          value: 'nfc_writing',          color: theme.status.info     },
  { label: 'QA Check',           value: 'qa_pending',           color: theme.status.warning  },
  ...
  // ── Legacy / failure states (kept for data compatibility) ──────────────────
